...
//     userId, // THÊM VÀO ĐÂY để callback nhận user
//   }
...
//     order_url: result.orderurl, // RIGHT FIELD
//   })
// }
...
export async function POST(req: NextRequest) {
  ...
  const embed_data = {
    redirecturl: 'http://localhost:3000/',
    userId, // để callback nhận user
  }
  const ipnUrl = 'https://a91a5c42c49f.ngrok-free.app/api/zalopay-ipn'
