...
import { toast } from 'sonner' // nếu bạn đã cài sonner để hiển thị toast
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Switch
                              ...
                              onCheckedChange={(checked) => {
                                if (!isVip) {
                                  toast.warning('Password protection feature is available for VIP accounts only.')
                                  return
                                }
                                handleLinkInputChange('passwordProtected', checked)
                              }}
                              disabled={isLoading}
                            />
                          </div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            ...
                            <Switch
                              ...
                              onCheckedChange={(checked) => {
                                if (!isVip) {
                                  toast.warning('Download limit feature is only available for VIP accounts.')
                                  return
                                }
                                handleLinkInputChange('allowDownloadLimit', checked)
                              }}
                              disabled={isLoading}
                            />
                          </div>
